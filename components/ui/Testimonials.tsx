...
const testimonials: Testimonial[] = [
  {
    ...
    location: 'Guadalajara, Jalisco',
            content: 'PakalFi saved my business when a flood damaged my store. The automatic payment arrived in less than 24 hours, allowing me to reopen quickly. The process was incredibly simple!',
    rating: 5,
  ...
  },
  {
    ...
    location: 'Mexico City',
            content: 'As a taxi driver, I was always worried about accidents. With PakalFi, I feel protected and the premiums are very affordable. The app is easy to use and customer service is excellent.',
    rating: 5,
  ...
  },
  {
    ...
    location: 'Monterrey, Nuevo León',
            content: 'I never thought I could afford health insurance. PakalFi made it possible with their affordable plans. When my son got sick, the coverage was perfect and the claims process was very fast.',
    rating: 5,
  ...
  },
  {
    ...
    location: 'Tijuana, Baja California',
            content: 'Working in construction is risky, but PakalFi gives me peace of mind. The security coverage is comprehensive and the automatic payments work perfectly. Highly recommended!',
    rating: 5,
